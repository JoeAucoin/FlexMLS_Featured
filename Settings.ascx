<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="GIBS.Modules.FlexMLS_Featured.Settings" %>
...
<div id="MainSection" runat="server">
    ...
    <dnn:label id="lblItemCssClass" runat="server" controlname="txtItemCssClass" suffix=":" />
            <asp:textbox id="txtItemCssClass" runat="server" Text="col-md-12 col-sm-6 col-xs-6" />		
        </div>
    ...
    <dnn:label id="lblMLSImagesUrl" runat="server" controlname="txtMLSImagesUrl" suffix=":" />
        ...
        <div class="dnnFormItem">
	     ...
	     <div class="dnnFormItem">
            ...
            <asp:Textbox ID="txtNumberOfRecords" runat="server" Text="20" />
        </div>	      
 	     ...
 	     <div class="dnnFormItem">
            <dnn:label id="lblShowCriteria" runat="server" controlname="cbxShowCriteria" suffix=":" ResourceKey="lblShowCriteria" />
            <asp:CheckBox ID="cbxShowCriteria" runat="server" />

        </div>	 
		
 	     <div class="dnnFormItem">
            <dnn:label id="lblShowTotalRecords" runat="server" controlname="cbxShowTotalRecords" suffix=":" ResourceKey="lblShowTotalRecords" />
            <asp:CheckBox ID="cbxTotalRecords" runat="server" />
...
<dnn:sectionhead id="sectUnUsedSettings" cssclass="Head" runat="server" text="Filter Listings Settings" section="UnUsedSection"
	includerule="False" isexpanded="True"></dnn:sectionhead>
...
<asp:DropDownList ID="ddl_Town" runat="server" Width="20%" AutoPostBack="True" onselectedindexchanged="ddl_Town_SelectedIndexChanged"  /> <asp:DropDownList ID="ddl_Village" runat="server" Width="20%" EnableViewState="true" CausesValidation="false" /> 
        ...
        <div class="dnnFormItem">
            <dnn:label id="lblListingOfficeMLSID" runat="server" suffix=":" controlname="txtListingOfficeMLSID" ResourceKey="lblListingOfficeMLSID" />
